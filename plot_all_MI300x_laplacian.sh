...
#check for num iters and time
  dir_name_output="/home/kswirydo/LAP_PNNL/REP_${idx}_MI300x_LAPLACIAN/${mtxs}/output_results/"
...
#Incomple Cholesky 5
  ...
  for ((i=0; i < num_files; i++)); do
   ...
   echo
   echo
   echo $mtxs ',Gauss-Seidel,'  ${time_res[0]} >> /home/kswirydo/LAP_PNNL/LAPLACIAN_runtimes/runtime_MI300X_REP_${idx}.csv
   echo $mtxs ',Two Stage GS,'  ${time_res[1]} >> /home/kswirydo/LAP_PNNL/LAPLACIAN_runtimes/runtime_MI300X_REP_${idx}.csv
   echo $mtxs ',Two Stage Jac+GS,'  ${time_res[2]} >> /home/kswirydo/LAP_PNNL/LAPLACIAN_runtimes/runtime_MI300X_REP_${idx}.csv
   echo $mtxs ',line Jacobi,' ${time_res[3]} >> /home/kswirydo/LAP_PNNL/LAPLACIAN_runtimes/runtime_MI300X_REP_${idx}.csv
