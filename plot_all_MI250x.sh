...
for idx in {1..2}; do
  ...
  echo "Matrix,Preconditioner,Execution Time (in seconds)" >> /home/kswirydo/LAP_PNNL/CG_runtimes/runtime_MI250_REP_${idx}.csv
...
#check for num iters and time
  dir_name_output="/home/kswirydo/LAP_PNNL/REP_${idx}_MI250_CG/${mtxs}/output_results/"
...
#Incomple Cholesky 5
  ...
  for ((i=0; i < num_files; i++)); do
   ...
   echo
   echo
   echo $mtxs ',Gauss-Seidel,'  ${time_res[0]} >> /home/kswirydo/LAP_PNNL/CG_runtimes/runtime_MI250_REP_${idx}.csv
   echo $mtxs ',Two Stage GS,'  ${time_res[1]} >> /home/kswirydo/LAP_PNNL/CG_runtimes/runtime_MI250_REP_${idx}.csv
   echo $mtxs ',Two Stage Jac+GS,'  ${time_res[2]} >> /home/kswirydo/LAP_PNNL/CG_runtimes/runtime_MI250_REP_${idx}.csv
   echo $mtxs ',line Jacobi,' ${time_res[3]} >> /home/kswirydo/LAP_PNNL/CG_runtimes/runtime_MI250_REP_${idx}.csv
   echo $mtxs ',iterative Jacobi,' ${time_res[4]} >> /home/kswirydo/LAP_PNNL/CG_runtimes/runtime_MI250_REP_${idx}.csv
   echo $mtxs ',Incomple Cholesky,' ${time_res[5]} >> /home/kswirydo/LAP_PNNL/CG_runtimes/runtime_MI250_REP_${idx}.csv
done
...
rm energy_MI250_REP_${idx}.csv
#cat *_REP${idx}.csv 
cat *_REP${idx}.csv >> energy_MI250_REP_${idx}.csv
