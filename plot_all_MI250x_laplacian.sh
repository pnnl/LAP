...
for idx in {1..2}; do
  ...
  mtxs=`dirname $mtx`
  dir_name="/home/kswirydo/LAP_PNNL/REP_${idx}_MI250_LAPLACIAN/${mtxs}/power_results/"
...
#check for num iters and time
  dir_name_output="/home/kswirydo/LAP_PNNL/REP_${idx}_MI250_LAPLACIAN/${mtxs}/output_results/"
...
echo "CHUJEMUE PRINTING TO FILES"
   ...
   echo $mtxs ',line Jacobi,' ${time_res[3]} >> /home/kswirydo/LAP_PNNL/LAPLACIAN_runtimes/runtime_MI250_REP_${idx}.csv
   echo $mtxs ',iterative Jacobi,' ${time_res[4]} >> /home/kswirydo/LAP_PNNL/LAPLACIAN_runtimes/runtime_MI250_REP_${idx}.csv
   echo $mtxs ',Incomple Cholesky,' ${time_res[5]} >> /home/kswirydo/LAP_PNNL/LAPLACIAN_runtimes/runtime_MI250_REP_${idx}.csv
done
